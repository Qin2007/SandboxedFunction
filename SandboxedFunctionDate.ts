...
//     const match: RegExpMatchArray | null = String(toParse).match(dateTimeRegex);
//     if (match !== null) {
//         try {
...
// import {expressionArray, Invalid, TimeTypes} from "./evaluate.js";
...
//                     context.ExpressionArray.push({type: 'SBFunctionCall', value});
...
//                     if (expression.type === 'SBFunctionCall') {
//                         /*let value;
