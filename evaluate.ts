...
// import {SandboxedFunctionInternalError} from "./SandboxedFunctionDate.js";
// import {instructionToken} from "./SandboxedFunction.js";

export const __undef: unique symbol = Symbol.for('__undef');
export type __undef = typeof __undef;
export const Invalid: unique symbol = Symbol.for('Invalid');
...
//     public _instructionToken: instructionToken;
//
//     constructor(pathName: (string | symbol | TimeTypes)[], instructionToken: instructionToken) {
//         this._instructionToken = instructionToken;
...
//         }
//         if (called) {
//             expressionArray[index] = returnV;
//         } else {
//             throw new SandboxedFunctionInternalError('function not prsent', instructionToken)
//         }
//         // if (typeOf(theActualFunction) === 'function') {
